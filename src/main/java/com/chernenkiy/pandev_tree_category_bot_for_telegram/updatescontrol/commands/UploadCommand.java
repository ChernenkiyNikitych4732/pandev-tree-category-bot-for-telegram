...
public class UploadCommand implements CommandHandler {
    ...
    private final Map<Long, MainChatStatus> chatStates;
    ...
    public UploadCommand(TelegramBotUpdatesControl bot, Map<Long, MainChatStatus> chatStates, CategoryService categoryService) {
        this.bot = bot;
    ...
    public void execute(Update update) {
        ...
        chatStates.put(chatId, MainChatStatus.Upload_file);
