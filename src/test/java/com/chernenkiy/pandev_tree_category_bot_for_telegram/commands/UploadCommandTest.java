...
import com.chernenkiy.pandev_tree_category_bot_for_telegram.updatescontrol.commands.UploadCommand;
...
class UploadCommandTest {
    ...
    void testExecute() {
        ...
        assertEquals(MainChatStatus.Upload_file, chatStates.get(12345L));
    }
    ...
    void testHandle_ValidExcelFile_FromResources() throws Exception {
        ...
        File testExcelFile = new File("src/test/resources/categories_tree.xlsx");
